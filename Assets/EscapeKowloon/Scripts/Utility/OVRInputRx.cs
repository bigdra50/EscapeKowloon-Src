// https://github.com/bigdra50/OVRInputRx
...
namespace EscapeKowloon.Scripts.Utility
{
    public static class OVRInputRx
    {
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.Button, OVRInput.Controller, bool>>
            OVR_DELEGATE_BUTTON_MAP =
        ...
        static IObservable<Unit> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.RawButton button)
        {
            ...
            return Observable.EveryUpdate()
                .Where(_ => OVR_DELEGATE_RAWBUTTON_MAP[ovrInputEventType](button, controllerMask)).AsUnitObservable();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.RawButton, OVRInput.Controller, bool>>
            OVR_DELEGATE_RAWBUTTON_MAP =
        ...
        static IObservable<Unit> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.Button button)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate()
                .Where(_ => OVR_DELEGATE_BUTTON_MAP[ovrInputEventType](button, controllerMask)).AsUnitObservable();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.Touch, OVRInput.Controller, bool>>
            OVR_DELEGATE_TOUCH_MAP =
        ...
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate().Where(_ => OVR_DELEGATE_TOUCH_MAP[ovrInputEventType](touch, controllerMask))
                .AsUnitObservable();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.RawTouch, OVRInput.Controller, bool>>
            OVR_DELEGATE_RAWTOUCH_MAP =
        ...
        static IObservable<Unit> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.RawTouch touch)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate()
                .Where(_ => OVR_DELEGATE_RAWTOUCH_MAP[ovrInputEventType](touch, controllerMask)).AsUnitObservable();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.NearTouch, OVRInput.Controller, bool>>
            OVR_DELEGATE_NEARTOUCH_MAP =
        ...
        static IObservable<Unit> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.NearTouch touch)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate()
                .Where(_ => OVR_DELEGATE_NEARTOUCH_MAP[ovrInputEventType](touch, controllerMask)).AsUnitObservable();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.RawNearTouch, OVRInput.Controller, bool>>
            OVR_DELEGATE_RAWNEARTOUCH_MAP =
        ...
        static IObservable<Unit> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.RawNearTouch touch)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate()
                .Where(_ => OVR_DELEGATE_RAWNEARTOUCH_MAP[ovrInputEventType](touch, controllerMask)).AsUnitObservable();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.Axis1D, OVRInput.Controller, float>>
            OVR_DELEGATE_AXIS1D_MAP =
        ...
        static IObservable<float> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.Axis1D axis1d)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate()
                .Select(ovrAxis1D => OVR_DELEGATE_AXIS1D_MAP[ovrInputEventType](axis1d, controllerMask))
                .AsObservable<float>();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.RawAxis1D, OVRInput.Controller, float>>
            OVR_DELEGATE_RAWAXIS1D_MAP =
        ...
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate().Select(ovrRawAxis1D =>
                    OVR_DELEGATE_RAWAXIS1D_MAP[ovrInputEventType](axis1d, controllerMask))
                .AsObservable<float>();
        }
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.Axis2D, OVRInput.Controller, Vector2>>
            OVR_DELEGATE_AXIS2D_MAP =
        ...
        static IObservable<Vector2> GetOrCreateSubject(OVRInputEventType ovrInputEventType, OVRInput.Axis2D axis2d)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate()
                .Select(ovrAxis2D => OVR_DELEGATE_AXIS2D_MAP[ovrInputEventType](axis2d, controllerMask))
        ...
        static readonly Dictionary<OVRInputEventType, Func<OVRInput.RawAxis2D, OVRInput.Controller, Vector2>>
            OVR_DELEGATE_RAWAXIS2D_MAP =
        ...
        static IObservable<Vector2> GetOrCreateSubject(OVRInputEventType ovrInputEventType,
            OVRInput.RawAxis2D rawaxis2d)
        {
            var controllerMask = OVRInput.Controller.Active;
            return Observable.EveryUpdate().Select(ovrRawAxis2D =>
                    OVR_DELEGATE_RAWAXIS2D_MAP[ovrInputEventType](rawaxis2d, controllerMask))
                .AsObservable<Vector2>();
        }
